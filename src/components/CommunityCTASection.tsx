    ...
    return (
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full">
                ...
                <div className="absolute bottom-20 left-32 w-24 h-24 bg-blue-300/20 rounded-full blur-xl"></div>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
                ...
                >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className="group bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 px-12 py-6 rounded-full font-bold text-xl shadow-2xl hover:shadow-yellow-500/25 transition-all duration-300 transform hover:-translate-y-1"
                    >
